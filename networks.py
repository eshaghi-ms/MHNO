...
class FNO2d(nn.Module):
    def __init__(self, modes1, modes2, width, width_q, width_h, T_in, T_out, n_layers, n_layers_q, n_layers_h):
        ...
        self.p = nn.Linear(T_in + 2, self.width)
...
class TNO2d(FNO2d):
    def __init__(self, modes1, modes2, width, width_q, width_h, T_in, T_out, n_layers, n_layers_q, n_layers_h):
        super(TNO2d, self).__init__(modes1, modes2, width, width_q, width_h, T_in, T_out, n_layers, n_layers_q, n_layers_h)

        self.q = MLP2d(self.width, 1, self.width_q, T_out, self.n_layers_q)
        # self.q = MLP2d(self.width, 1, self.width_q, 1, self.n_layers_q)
...
class TNO3d(FNO3d):
    def __init__(self, modes1, modes2, modes3, width, width_q, width_h, T_in, T_out, n_layers, n_layers_q, n_layers_h):
        super(TNO3d, self).__init__(modes1, modes2, modes3, width, width_q, width_h, T_in, T_out, n_layers, n_layers_q, n_layers_h)
        """
